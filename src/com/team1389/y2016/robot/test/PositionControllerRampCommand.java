...
public class PositionControllerRampCommand extends Command{
	...
	public PositionControllerRampCommand(TalonSRXPositionHardware controller, SetpointProvider setpointProvider, PIDConstants pidC, double maxPos, double minPos, double maxChange) {
