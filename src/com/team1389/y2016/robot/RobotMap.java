...
public class RobotMap {
	...
	public static final double wheelRotationsPerTurn = (22.5 / 7.5) * 1.25;
	public static final double maxAutonVelocity = 1;
	public static final double maxAutonAcceleration = .5;
	...
	//Arm config
	public static final ConfigurablePid armPid = new ConfigurablePid("armPID", new PIDConstants(.3, 0, 0, 0, 0));
